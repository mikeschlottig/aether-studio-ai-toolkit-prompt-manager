  ...
  return (
    <div className="min-h-screen bg-background relative overflow-hidden">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative pt-24 pb-20">
        ...
        {/* Footer */}
        <footer className="mt-40 border-t border-border pt-12 flex flex-col md:flex-row items-center justify-between gap-6 text-muted-foreground text-sm">
          <div className="flex items-center gap-2">
            <div className="w-6 h-6 rounded bg-indigo-600" />
            <span className="font-bold text-foreground">Aether Studio</span>
          </div>
          <p>© 2025 Aether Agency. Built with Cloudflare Agents.</p>
